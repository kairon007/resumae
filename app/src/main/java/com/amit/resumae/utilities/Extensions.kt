...
fun WebView.createPrintJob(context: Context) {
	...
	val printAdapter = this.createPrintDocumentAdapter("Resumae document")
	val printJob = printManager.print("Resumae Job", printAdapter, PrintAttributes.Builder().build())
}
