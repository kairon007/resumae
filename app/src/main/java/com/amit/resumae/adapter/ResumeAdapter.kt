...
class ResumeAdapter(val onResumeCardClick: (resumeId: Long) -> Unit) : RecyclerView.Adapter<ResumeAdapter.ResumeViewHolder>() {
	...
	override fun onCreateViewHolder(parent : ViewGroup, position : Int): ResumeViewHolder = ResumeViewHolder(LayoutInflater.from(parent.context).inflate(
		R.layout.card_resume, parent, false))
